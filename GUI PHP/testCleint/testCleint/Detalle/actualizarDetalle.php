...
<html>
    ...
    <body>  
        ...
        {               
           ...
           if(actualizarDetalle($_GET['InputPedidoID'],$_GET['InputProductoID'],$_GET['nameInputCantidad']) == true)
            {
                $idStatus = "Se ha Actualizado Exitosamente el Detalle";   
            }
            else
            {
                $idStatus = "Hubo un error al Actualizar el Detalle";   
            }        
        }     
        ...
        <br>           
<form action="actualizarDetalle.php" method="get" align="center">
    
  <div class="input-group flex-nowrap">    
    <span class="input-group-text">ID Producto</span>    
    <input type="number" class="form-control" placeholder="Ingrese el ID PRODUCTO" value = "<?php echo (isset($varProductoID))?$varProductoID :'';?>" name="InputProductoID" min="1" max="500" required>
 ...
 <div class="d-flex justify-content-center" style="width: 100%; background-color: rgba(0,0,255,.1)">   
        <label class="h3" >Ingrese la nueva cantidad del Detalle</label>       
        </div>
 
 <br> 
 
 <div class="input-group mb-3">       
  <span class="input-group-text" id="inputGroup-sizing-default">Nueva Cantidad</span>  
  <input  type="number" class="form-control"  name="nameInputCantidad" value = "">
</div>
 ...
 <br>  
  ...
  <input type="submit" class="btn btn-primary" name="updateButton" value="Actualizar Detalle">
